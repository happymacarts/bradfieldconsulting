...
<div id="carousel-example-generic" class="carousel slide"
	...
	<div class="carousel-inner" role="listbox">
      ...
      <img src="..." alt="..."> -->
			<div class="jumbotron" 
			style="background-image:url('{{asset('images/dea616b5-1ccb-4cd.jpg')}}');    
		...
		<div class="col-sm-12">
			...
			<p>
				A team of financial experts <strong>in business for over {{
					Date('Y') - 2012}} years</strong>, our Chief Consultants, Ana
	...
	<div class="row">
		...
		<p>
			...
			Over the years I have <strong>developed relationships with some of
				the industry's top leaders</strong> in Human Resources, Payroll, and
			Small Business Insurance just to name a few. As a team, we make sure
			that you can access your data round the clock without any hassles to
			keep you on top of your finances, including but not limited to:
			working out of your office, utilization of Virtual Private Networks,
			Portable External Hard Drive or Dropbox. <strong>Your data remains
				safe and secure with us.</strong> We have taken special measures to
			safeguard your data against leakage, theft or loss by destruction. In
			addition to offsite work, <strong>we also provide &quot;On Site&quot;
				services.</strong> We understand that part of owning a successful
			business is always having the financial data at your fingertips. By
			offering On Site Services, <em>we can ensure that your business
				accounting department is "business as usual".</em>
		</p>

		<h1>Why we can help</h1>
		<p>
			Any business <strong>new</strong> or <strong>old</strong>, <strong>big</strong>
			or <strong>small</strong>, needs <em>efficient and correct accounting
				reports</em> to sustain and <em><strong>GROW</strong></em>. Having
			your accounts in top shape all year round is a remarkable achievement
			that can help your business function smoothly and provide grounds for
			sound and promising business decisions. Unfortunately, <strong>many
				small business owners, are unable to give the Accounting the time
				and attention it deserves</strong>. Thereby, <em>losing money to a
				variety of unnecessary fees, overcharges, and high interest credit
				card fees</em> just to name a few. As your accounting needs will
			continue to grow with your business, owners need to pay careful
			thought to a <em>long term and viable solution for this vital part</em>
			of your business. By hiring <strong>Bradfield Consulting</strong> to
			take care of <strong>all your accounting needs</strong>, you can
			ensure a step in the right direction. By letting us be your
			professional accountants, not only would you have availed the
			services of <em>highly qualified, experienced professionals not
				commonly available at an affordable price for small businesses</em>,
			you would also have <strong>more time and saved resources to run your
				business successfully</strong>. Given the opportunity to work for
			your promising company, we will prove with our dedication and high
			performance that you <strong>have actually bought peace of mind for
				yourself in the guise of our professional accounting services</strong>.
		</p>
	</div>
</div>
</div>
